...
namespace Catalog.Repository.Migrations
{
    ...
    [Migration("20210301203750_ProductStockChannelCode")]
    partial class ProductStockChannelCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Domain.ImageAggregate.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Catalog.Domain.CategoryAggregate.CategoryImage", b =>
                {
                    b.HasOne("Catalog.Domain.ImageAggregate.Image", "Image")
                        .WithOne()
                        .HasForeignKey("Catalog.Domain.CategoryAggregate.CategoryImage", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Catalog.Domain.ProductAggregate.ProductImage", b =>
                {
                    b.HasOne("Catalog.Domain.ImageAggregate.Image", "Image")
                        .WithOne()
                        .HasForeignKey("Catalog.Domain.ProductAggregate.ProductImage", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade);
