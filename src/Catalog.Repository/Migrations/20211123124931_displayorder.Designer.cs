...
namespace Catalog.Repository.Migrations
{
    ...
    [Migration("20211123124931_displayorder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.Property<int>("ProductFilterOrder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Catalog.Domain.ValueObject.StoreProcedure.AttributeFilter", b =>
                {
                    ...
                    b.Property<string>("AttributeSeoName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Catalog.Domain.BannerAggregate.Banner", b =>
                {
                    b.HasOne("Catalog.Domain.BannerAggregate.BannerLocation", null)
                        .WithMany("Banners")
                        .HasForeignKey("BannerLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
